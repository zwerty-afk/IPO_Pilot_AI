...
export default function IpoReadinessPage() {
  ...
  // Compute total missing items across app
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* 1. Master Top Readiness Banner & Score Card */}
      <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900">Executive IPO Readiness Dashboard</h2>
              <p className="text-slate-500 text-xs mt-0.5">
                Master SEBI IPO readiness score and statutory verification audit for <span className="font-bold text-slate-800">{readinessData?.companyName}</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4 shrink-0">
          <div className="bg-gradient-to-br from-slate-900 to-indigo-950 text-white p-5 rounded-2xl shadow-lg border border-slate-800 flex items-center gap-5 shrink-0 min-w-[260px]">
            <div className="relative w-16 h-16 flex items-center justify-center shrink-0">
              ...
              <div className="absolute text-center">
                <span className="text-lg font-extrabold text-white block leading-none">{score}%</span>
              </div>
            </div>

            <div>
              <span className="text-[10px] font-mono text-indigo-300 font-bold uppercase block tracking-wider">Status Designation</span>
              <span className="text-base font-bold text-white block leading-snug">{label}</span>
              <span className="text-[10px] text-slate-400 block mt-0.5">{certifiedCount} of 11 chapters certified</span>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-indigo-900 via-indigo-950 to-slate-900 text-white p-5 rounded-2xl shadow-md border border-indigo-800/50 space-y-2">
        ...
        <p className="text-slate-200 text-xs leading-relaxed font-sans">{summaryText}</p>
      </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-3">
          <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
            <span className="font-bold text-slate-800 text-xs uppercase tracking-wider font-mono flex items-center gap-1.5">
              ...
              Missing Intake Fields ({missingFieldsCount})
            </span>
          ...
          {missingFieldsList.length > 0 ? (
            ...
            <p className="text-xs text-emerald-700 font-semibold flex items-center gap-1">
              <CheckCircle2 className="w-3.5 h-3.5" /> All required intake fields across all 11 chapters are filled.
            </p>
          )}
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-3">
          <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
            <span className="font-bold text-slate-800 text-xs uppercase tracking-wider font-mono flex items-center gap-1.5">
              ...
              Missing Statutory Documents ({missingDocsCount})
            </span>
          ...
          {missingDocsList.length > 0 ? (
            ...
            <p className="text-xs text-emerald-700 font-semibold flex items-center gap-1">
              <CheckCircle2 className="w-3.5 h-3.5" /> All required statutory documents are uploaded and verified.
            </p>
          )}
        </div>
      </div>
